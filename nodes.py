...
class LoraLoader:
    ...
    def load_lora(self, model, clip, lora_name, strength_model, strength_clip):
        ...
        model_lora, clip_lora = sd.load_lora_for_models(model, clip, lora_state_dict, strength_model, strength_clip)
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "DITLoraLoader": "HunYuan DIT Lora Loader",
}
